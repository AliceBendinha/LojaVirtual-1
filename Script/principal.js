...
function exibirCarrinho() {
    ...
    const buttonsRemover = document.querySelectorAll('.remover');
...
// Função de login
const users = [
    { email: 'admin1@example.com', password: 'senha1' },
    { email: 'admin2@example.com', password: 'senha2' },
    { email: 'admin3@example.com', password: 'senha3' },
    { email: 'admin4@example.com', password: 'senha4' },
];
